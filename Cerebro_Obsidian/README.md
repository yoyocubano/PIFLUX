...
3. Go to the vault menu and chose “Open folder as vault”, select the folder ("Obsidian-Vault-Project-Management-main") you extracted and trust the plugins.
...
### Daily Notes:
You can open the daily note for today or tomorrow by clicking on the respective buttons located in the toolbar that sticks to the top of your screen. 
![image](https://github.com/user-attachments/assets/c55bba87-8761-4323-acc2-7f134e130ac9)

It will create a new note with todays or tomorrows date and a number. This means you can have multiple daily notes, when you work on multiple things at once on the same day!
...
![image](https://github.com/user-attachments/assets/fed2bcb1-0e7d-4f83-a947-50a9cb8086fa)
